...
\end{minted}
On the oscilloscope are plotted first the UARTRX and second the RRDY pulse, the latter is received at the end of the full transmission (Figure~\ref{fig:P51OS}).
...
\end{minted}
Looking to the oscilloscope, a pulse is received after every full transmission (Figure~\ref{fig:P52OS}).
