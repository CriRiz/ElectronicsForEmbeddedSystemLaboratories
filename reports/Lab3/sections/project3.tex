...
In the first scenario, the aim is to send a single character through the transmission data register, as it can be seen in line 30 of the code in Figure \ref{lst:P31}, and then compare the STATUS register before and after the transmission, as illustrated in lines 23–24 and 32–33 in the code in Figure \ref{lst:P31}.
...
\begin{itemize}
    ...
    \item E.
\end{itemize}
It can be observed that the TRDY flag is no longer active after the character is written to the transmission data register in line 30 of the code (Figure \ref{lst:P31}).
