...
In this project is coded a multiple chars transmissions. Previously, messages were sent without waiting the TRDY flag in the control register, which made the procedure prone to communication errors.
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.5\textwidth]{figures/PROJECT_4_1_OSC.png}
	\end{center}
\end{figure}
