...
The Cyclone V FPGA is used to build the SAR logic in VHDL, while the on-board ADV7123 Digital-to-Analog Converter and an external LM393 comparator are used to perform the analog comparison that is required during the conversion process.
